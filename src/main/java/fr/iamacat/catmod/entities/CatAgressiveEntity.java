...
public class CatAgressiveEntity extends EntityMob {
    ...
    public CatAgressiveEntity(World p_i1738_1_) {
        ...
        this.tasks.addTask(2, new EntityAIAttackOnCollide(this, EntityPlayer.class, 1.0D, false));// does it attack
                                                                                                  // player? 1.0D = 0.5
                                                                                                  // heart of attack
        ...
        this.targetTasks.addTask(2, new EntityAINearestAttackableTarget(this, EntityPlayer.class, 0, true));// can be
                                                                                                            // capable
                                                                                                            // to hit
                                                                                                            // players?
        this.targetTasks.addTask(2, new EntityAINearestAttackableTarget(this, EntityVillager.class, 0, false));// can be
                                                                                                               // capable
                                                                                                               // to hit
                                                                                                               // villagers?
