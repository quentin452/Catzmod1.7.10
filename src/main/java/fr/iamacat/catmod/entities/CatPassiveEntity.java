...
public class CatPassiveEntity extends EntityAnimal {
    ...
    public CatPassiveEntity(World p_i1689_1_) {
        super(p_i1689_1_);
    ...
    public void onStruckByLightning(EntityLightningBolt lightningBolt) {
        if (!this.worldObj.isRemote) {
             ...
             * entitypigzombie.setLocationAndAngles(this.posX, this.posY, this.posZ, this.rotationYaw,
             * this.rotationPitch);
    ...
    public CatPassiveEntity createChild(EntityAgeable p_90011_1_) {
