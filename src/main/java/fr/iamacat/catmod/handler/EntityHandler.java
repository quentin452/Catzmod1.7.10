...
public class EntityHandler
{
    public static void registerMonster(Class entityclass, String string){
        ...
        EntityRegistry.registerGlobalEntityID(entityclass, string, EntityRegistry.findGlobalUniqueEntityId(), new Color(0, 221, 243).getRGB(), new Color(243, 0, 0).getRGB());//needed to make eggs for entities
